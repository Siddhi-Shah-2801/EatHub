...
<head>
    <?php session_start(); include("../connectionDB.php"); include('../head.php');?>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="../css/customerLogin.css" rel="stylesheet">

    <title>Customer Registration | Somaiya Canteen</title>
</head>
...
<body class="d-flex flex-column">
    ...
    <div class="container form-signin mt-auto">
        ...
        <br>
        <a class="nav nav-item text-decoration-none text-muted" href='../fileHandling.php'>
            <i class="bi bi-question-circle"></i>Help
        </a>
       
        <form method="POST" action="addCustomer.php" class="form-floating">
            ...
            <button class="w-100 btn btn-success mb-3"  type="submit" value="sendMail">Sign Up</button>
        </form>
    </div>
    <div class="container mt-4"></div>
</body>
