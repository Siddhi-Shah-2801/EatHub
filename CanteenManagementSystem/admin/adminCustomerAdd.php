...
<head>
    ...
    if(isset($_POST["buttonAdd"])){
        ...
        <?php
            ...
            VALUES ('$username','$pwd','$firstname','$lastname','$email','$gender','$customerType');";
            $result = $mysqli -> query($query);
            if($result){
                header("location: adminCustomerList.php?addCustomer=1");
            }else{
                header("location: adminCustomerList.php?addCustomer=0");
            }
        }
        exit(1);
    }
    ...
    <title>Add New Customer |Somaiya Canteen</title>
</head>
...
<body class="d-flex flex-column">
    ...
    <div class="container form-signin mt-auto">
        ...
        <form method="POST" action="adminCustomerAdd.php" class="form-floating">
